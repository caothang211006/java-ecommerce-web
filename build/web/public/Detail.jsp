                                                ...
                                                <c:when test="${detail.discount > 0}">
                                                    ...
                                                    <div style="display:flex; align-items:center; gap:10px;">
                                                        <span style="color:#e00; font-weight:700; font-size:30px; letter-spacing:0.5px;">
                                                            <fmt:formatNumber value="${detail.price - (detail.price * detail.discount / 100)}" type="number" groupingUsed="true"/> đ
                                                        </span>
                                                    ...
                                                    <div style="font-size:12px; color:green; margin-top:4px;">
                                                        ✔ Bạn tiết kiệm được <fmt:formatNumber value="${detail.price * detail.discount / 100}" type="number" groupingUsed="true"/> đ
                                                    </div>
                                                </c:when>
                                                <c:otherwise>
